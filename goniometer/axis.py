...
It contains the "Axis" class that creates:
    ...
    - The "channel" variable that contains one of the two goniometer axes channel value previously configure on the Biometrics DataLite application
...
class Axis:
    def __init__(self, channel, sampleRate = 1000):
        # Channel variable
