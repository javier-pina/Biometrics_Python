...
def comenzar(ejes):
    ...
    if threading.active_count() == 1:
        ...
        thread = threading.Thread(name="hilo_canal_0", daemon=True, target=recoleccion_datos, args=(ejes[0], ani, durationSecs, samplesLeftToPlot))
        thread.start()
        
        
        thread1 = threading.Thread(name="hilo_canal_1", daemon=True, target=recoleccion_datos, args=(ejes[1], ani, durationSecs, samplesLeftToPlot))
        thread1.start()
        

        """
        thread2 = threading.Thread(name="hilo_canal_2", daemon=True, target=recoleccion_datos, args=(ejes[2], ani, durationSecs, samplesLeftToPlot))
        thread2.start()

        thread3 = threading.Thread(name="hilo_canal_3", daemon=True, target=recoleccion_datos, args=(ejes[3], ani, durationSecs, samplesLeftToPlot))
        thread3.start()

        
        thread4 = threading.Thread(name="hilo_canal_4", daemon=True, target=recoleccion_datos, args=(ejes[4], ani, durationSecs, samplesLeftToPlot))
        thread4.start()

        thread5 = threading.Thread(name="hilo_canal_5", daemon=True, target=recoleccion_datos, args=(ejes[5], ani, durationSecs, samplesLeftToPlot))
        thread5.start()

        thread6 = threading.Thread(name="hilo_canal_6", daemon=True, target=recoleccion_datos, args=(ejes[6], ani, durationSecs, samplesLeftToPlot))
        thread6.start()

        thread7 = threading.Thread(name="hilo_canal_7", daemon=True, target=recoleccion_datos, args=(ejes[7], ani, durationSecs, samplesLeftToPlot))
        thread7.start()
        """
...
ruta_dll = "C:\\Users\\javie\\Desktop\\Biometrics\\OnLineInterface64.dll"
